...
class Customer(models.Model):
    ...
    billingAddress = models.CharField(max_length = 1000, default="India")
    addressline2 = models.CharField(max_length = 1000, default="India")
    city = models.CharField(max_length = 45,  default="HYD")
    country = models.CharField(max_length = 20,  default="India")
    state = models.CharField(max_length = 20,  default="AP")	
    zipCode = models.CharField(max_length = 10,  default="55555")	
